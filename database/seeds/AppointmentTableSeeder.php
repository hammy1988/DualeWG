...
class AppointmentTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $appointment_vergangenheit->start_at = Carbon::create('2020', '06', '14', '15', '00', '00')->format('Y-m-d H:i:s');
        ...
        $appointment_party = new Appointment();
        $appointment_party->title = 'Bier holen';
        $appointment_party->description = 'wichtig :P';
        $appointment_party->start_at = Carbon::create('2019', '12', '11', '18', '00', '00')->format('Y-m-d H:i:s');
        $appointment_party->fullday = true;
        $appointment_party->recurring = 1;
        $appointment_party->flatshare_id = $flatshare->id;
        $appointment_party->save();
    }
